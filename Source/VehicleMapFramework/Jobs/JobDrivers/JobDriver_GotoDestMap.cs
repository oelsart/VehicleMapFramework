...
public class JobDriver_GotoDestMap : JobDriverAcrossMaps
{
  ...
  {
    using var _ = new VirtualTeleporter(pawn, DestMap); //ScanCellのWorkなどの場合にVirtualTeleporterは必要
  ...
  {
    public override ThinkResult TryIssueJobPackage(Pawn pawn, JobIssueParams jobParams) => ThinkResult.NoJob;
  }
}