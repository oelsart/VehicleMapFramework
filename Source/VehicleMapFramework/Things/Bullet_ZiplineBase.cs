...
public abstract class Bullet_ZiplineBase : Bullet, IZiplineEnd
{
    ...
    Thing _equipment = null, ThingDef _targetCoverDef = null)
  {
    ...
    base.Launch(_launcher, _origin, _usedTarget, _intendedTarget, hitFlags, _preventFriendlyFire, _equipment,
      _targetCoverDef);
  ...
  protected override void TickInterval(int delta)
  {
    ...
    var rect = new Rect(Vector2.zero, VehicleMapView.MeshSize);
