...
public class ZiplineEnd : ThingWithComps, IZiplineEnd
{
    ...
    CustomZipline.ZipLineData ziplineData)
  {
    ...
    var drawPosB = launcherPos +
                   (Vector3.forward * ziplineData.LauncherOffset).RotatedBy((drawPosA - launcherPos).AngleFlat());
    var y = Mathf.Max(drawPosA.y, drawPosB.y) - Altitudes.AltInc;
    GenDrawOnVehicle.DrawLineBetweenInstanced(drawPosA.WithY(y), drawPosB.WithY(y), ziplineData.ZiplineMat,
      ziplineData.ZiplineWidth);
  }
