...
public static class Patch_Verb_ShootBeam_GetBeamHitNeighbourCells
{
  ...
  {
    return AccessTools.FindIncludingInnerTypes(typeof(Verb_ShootBeam),
      t =>
...
public static class Patch_Verb_ShootBeam_Delegate
{
  ...
  {
    yield return typeof(Verb_ShootBeam).FindIncludingInnerTypes(t => t.GetDeclaredMethods().FirstOrDefault(m => m.Name.Contains("<ApplyDamage>")));
    yield return typeof(Verb_ShootBeam).FindIncludingInnerTypes(t => t.GetDeclaredMethods().FirstOrDefault(m => m.Name.Contains("<BurstingTick>")));
    yield return typeof(Verb_ShootBeam).FindIncludingInnerTypes(t => t.GetDeclaredMethods().FirstOrDefault(m => m.Name.Contains("<TryGetHitCell>")));
  }
...
public static class Patch_Verb_CastAbilityJump_OnGUI
{
  public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
  {
    return Patch_Verb_Jump_OnGUI.Transpiler(instructions);
  }
}
...
public static class Patch_Verb_CastAbilityJump_ValidateTarget
{
  public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
  {
    return Patch_Verb_Jump_ValidateTarget.Transpiler(instructions);
  }
}
