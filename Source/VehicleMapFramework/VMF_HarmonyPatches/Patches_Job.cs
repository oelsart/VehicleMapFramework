...
public static class Patch_JobGiver_Work_TryIssueJobPackage
{
  ...
  public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator, MethodBase original)
  {
    ...
    var addedCodes = new[]
    {
      CodeInstruction.LoadArgument(1), new CodeInstruction(OpCodes.Ldloc_S, scanner), CodeInstruction.Call(typeof(Patch_JobGiver_Work_TryIssueJobPackage), nameof(AddSearchSet))
    };
  ...
  internal static Job NonScanJobAll(this WorkGiver workGiver, Pawn pawn)
  {
    ...
    {
      Region region2 = null;
      RegionTraverserAcrossMaps.BreadthFirstTraverse(region,
        (_, r) => r.Allows(traverseParms, true),
        r =>
        {
          if (r.Map == map2)
          {
...
public static class Patch_Pawn_PathFollower_StartPath
{
  public static bool Prefix(LocalTargetInfo dest, PathEndMode peMode, Pawn ___pawn)
  {
    ...
    if (___pawn.Map != destMap && ___pawn.CanReach(dest,
          peMode,
          Danger.Deadly,
          false,
          false,
...
public static class Patch_Toils_Goto_GotoCell
{
  public static void Postfix(IntVec3 cell, PathEndMode peMode, Toil __result)
  {
    __result.AddPreInitAction(() =>
    {
      ...
      var allTargets = new[]
      {
        curJob.targetA, curJob.targetB, curJob.targetC
      }.ConcatIfNotNull(curJob.targetQueueA).ConcatIfNotNull(curJob.targetQueueB);
      ...
      if (target.IsValid && actor.Map != target.Thing.MapHeld && actor.CanReach(target,
            peMode,
            Danger.Deadly,
            false,
            false,
...
public static class Patch_Toils_Goto_GotoBuild
{
  public static void Postfix(TargetIndex ind, Toil __result)
  {
    __result.AddPreInitAction(() =>
    {
      ...
      if (thingMap != null && actor.Map != thingMap && actor.CanReach(target,
            PathEndMode.Touch,
            Danger.Deadly,
            false,
            false,
  ...
  public static void Postfix(TargetIndex bedIndex, Toil __result)
  {
    ...
    __result.endConditions.Insert(0,
      () =>
      {
        ...
        if (pawn.Map != bed.Map && pawn.CanReach(bed,
              PathEndMode.OnCell,
              Danger.Deadly,
              false,
              false,
...
public static class Patch_GenClosest_ClosestThingReachable
{
  ...
  [PatchLevel(Level.Safe)]
  public static void Postfix(IntVec3 root, Map map, ThingRequest thingReq, PathEndMode peMode, TraverseParms traverseParams, float maxDistance, Predicate<Thing> validator, IEnumerable<Thing> customGlobalSearchSet, int searchRegionsMin, int searchRegionsMax,
    bool forceAllowGlobalSearch, RegionType traversableRegionTypes, bool ignoreEntirelyForbiddenRegions, bool lookInHaulSources, ref Thing __result)
  {
    if (!map.CrossMapContext || traverseParams.pawn is not { } pawn) return;
    ...
    __result ??= GenClosestCrossMap.ClosestThingReachable(root,
      map,
      thingReq,
      peMode,
      traverseParams,
...
public static class Patch_GenClosest_ClosestThing_Regionwise_ReachablePrioritized
{
  ...
  public static void Postfix(IntVec3 root, Map map, ThingRequest thingReq, PathEndMode peMode, TraverseParms traverseParams, float maxDistance, Predicate<Thing> validator, Func<Thing, float> priorityGetter, int minRegions, int maxRegions,
    bool lookInHaulSources, ref Thing __result)
  {
...
public static class Patch_ToilFailConditions_FailOnSomeonePhysicallyInteracting
{
  private static MethodInfo TargetMethod()
  {
    return AccessTools.FindIncludingInnerTypes(typeof(ToilFailConditions),
      t =>
      {
      ...
      if (toil.debugName == "MakeNewToils" && !found)
      {
        ...
        toil.AddPreInitAction(() =>
        {
          if (___job.targetB.HasThing && toil.actor.Map != ___job.targetB.Thing.MapHeld &&
              toil.actor.CanReach(___job.targetB,
                PathEndMode.Touch,
                Danger.Deadly,
                false,
                false,
                TraverseMode.ByPawn,
                ___job.targetB.Thing.MapHeld,
                out var exitSpot,
                out var enterSpot,
                out var spotsQueue))
          {
...
public static class Patch_WorkGiver_ConstructDeliverResources_ResourceDeliverJobFor_Delegate
{
  private static MethodBase TargetMethod()
  {
    ...
    return AccessTools.FindIncludingInnerTypes(typeof(WorkGiver_ConstructDeliverResources),
      t =>
      {
  ...
  public static void Finalizer(Pawn pawn, VirtualTeleporter? __state, ref Job __result)
  {
    if (__state is not null)
    {
      if (__result is not null &&
          pawn.CanReach(__result.targetA,
            PathEndMode.Touch,
            Danger.Deadly,
            false,
            false,
