...
public static class Patch_Map_MapUpdate
{
  ...
  public static void Postfix(Map __instance)
  {
    ...
    if (focused && __instance.IsVehicleMapOf(out var vehicle) && VehicleMapFramework.settings.drawPlanet && WorldRendererUtility.DrawingMap && !Find.World.renderer.RegenerateLayersIfDirtyInLongEvent())
    {
      ...
      // 背景
      Graphics.DrawMesh(mesh200,
        center,
        Quaternion.identity,
        mat != null ? mat : SolidColorMaterials.SimpleSolidColorMaterial(Color.black),
        0);
...
public static class Patch_MapPawns_AllPawns
{
  ...
  [HarmonyReversePatch]
  public static List<Pawn> AllPawns(MapPawns instance)
  {
...
public static class Patch_ITab_Bills_FillTab_Delegate
{
  ...
  {
    return AccessTools.FindIncludingInnerTypes(typeof(ITab_Bills),
      t =>
      {
