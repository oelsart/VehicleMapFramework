...
public class CompBuildableContainer : CompTransporter
{
  ...
  public override IEnumerable<Gizmo> CompGetGizmosExtra()
  {
    ...
    {
      defaultLabel = "VF_LoadCargo".Translate(), icon = Vehicle.VehicleDef.LoadCargoIcon, action = delegate { Find.WindowStack.Add(new Dialog_LoadCargoToBuildableContainer(this)); }
    };
    yield return command_Action2;

    Command_Toggle command_Toggle = new()
    {
      defaultLabel = "VMF_GatherFromBaseMap".Translate(), icon = Vehicle.VehicleDef.LoadCargoIcon, isActive = () => gatherFromBaseMap, toggleAction = () => { gatherFromBaseMap = !gatherFromBaseMap; }
    };
