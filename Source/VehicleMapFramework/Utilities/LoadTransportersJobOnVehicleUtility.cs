...
public static class LoadTransportersJobOnVehicleUtility
{
  ...
  {
    return gatherFromBaseMap ? Patch_LoadTransportersJobUtility_FindThingToLoad.FindThingToLoad(p, transporter) : LoadTransportersJobUtility.FindThingToLoad(p, transporter);
  }
