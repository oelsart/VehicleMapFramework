...
public static class VehicleMapUtility
{
  ...
  extension(Map map)
  {
    ...
    [CanBeNull] public VehiclePawnWithMap ParentVehicle => map.IsVehicleMapOf(out var vehicle) ? vehicle : null;
  ...
  extension(float original)
  {
    ...
    {
      return original / YCompress + vehicle.cachedDrawPos.y + YOffsetBase;
    }
    ...
    {
      return original / YCompress + YOffsetBase;
    }
  }
