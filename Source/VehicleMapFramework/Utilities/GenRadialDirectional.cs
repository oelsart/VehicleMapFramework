...
public static class GenRadialDirectional
{
  ...
  static GenRadialDirectional()
  {
    ...
    for (var r = 0; r < 8; r++)
    {
      Patterns[r] = [.. tmpLists[r]];
      PatternRadii[r] = [.. Patterns[r].Select(c => c.LengthHorizontal)];
      BuildLookupTable(r);
    }
    ...
    static void BuildLookupTable(int r)
    {
      ...
      for (var i = 0; i <= RadialPatternCount; i++) table[i] = -1;
