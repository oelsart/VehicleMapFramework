...
public class VehicleMapFollower(VehiclePawnWithMap vehicle)
{
  ...
  private void CalculateMapCells()
  {
    ...
    var cellRect = CellRect.FromLimits(Mathf.Min(c1.x, c2.x, c3.x, c4.x), Mathf.Min(c1.z, c2.z, c3.z, c4.z),
      Mathf.Max(c1.x, c2.x, c3.x, c4.x), Mathf.Max(c1.z, c2.z, c3.z, c4.z));
