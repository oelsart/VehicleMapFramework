...
public static class LoadTransportersJobOnVehicleUtility
{
    ...
    public static bool HasJobOnTransporter(Pawn pawn, CompTransporter transporter)
    {
        ...
        if (LoadTransportersJobOnVehicleUtility.FindThingToLoad(pawn, transporter, transporter is not CompBuildableContainer container || container.GatherFromBaseMap, out _, out _).Thing == null)
        {
            return false;
        }
