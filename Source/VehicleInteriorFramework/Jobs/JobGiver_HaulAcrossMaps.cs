    ...
    public class JobGiver_HaulAcrossMaps : ThinkNode_JobGiver
    {
        protected override Job TryGiveJob(Pawn pawn)
        {
            ...
            Predicate<Thing> validator = delegate (Thing t)
            {
                ...
                StoreAcrossMapsUtility.TryFindBestBetterStoreCellFor(t, pawn, pawn.Map, StoreUtility.CurrentStoragePriorityOf(t), pawn.Faction, out intVec, true, out _, out _, out _);
            };
