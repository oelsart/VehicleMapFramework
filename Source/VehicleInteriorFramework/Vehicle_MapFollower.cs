...
{
    public class Vehicle_MapFollower
    {
        public Vehicle_MapFollower(VehiclePawnWithMap vehicle)
        {
        ...
        public void MapFollowerTick()
        {
            ...
            if (vehicle.Position != prevCell)
            {
                ...
                ticksToMove = Vehicle_PathFollower.MoveTicksAt(vehicle, prevCell, vehicle.Position);
        ...
        private void CalculateMapCells()
        {
            ...
            var mapRect = new Rect(0f, 0f, (float)mapSize.x, (float)mapSize.z);
        ...
        private ConcurrentSet<IntVec3> prevOccupiedCells = new ConcurrentSet<IntVec3>();

        private ConcurrentSet<IntVec3> tmpOccupiedCells = new ConcurrentSet<IntVec3>();
